...
set CP=%QFJ_HOME%/lib/mina-core-1.1.0.jar;%QFJ_HOME%/lib/slf4j-api-1.3.0.jar;%QFJ_HOME%/lib/slf4j-jdk14-1.3.0.jar;%QFJ_HOME%/quickfixj-all-1.3.3.jar;%QFJ_HOME%/quickfixj-core-1.3.3.jar;%QFJ_HOME%/quickfixj-msg-fix40-1.3.3.jar;%QFJ_HOME%/quickfixj-msg-fix41-1.3.3.jar;%QFJ_HOME%/quickfixj-msg-fix42-1.3.3.jar;%QFJ_HOME%/quickfixj-msg-fix43-1.3.3.jar;%QFJ_HOME%/quickfixj-msg-fix44-1.3.3.jar;%QFJ_HOME%/quickfixj-examples-1.3.3.jar
